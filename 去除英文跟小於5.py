...
trapath=r"C:\Users\user\Desktop\2019_proj\轉移率為去除英文小於5\Tra_M_66_up.csv"
sanpath=r"C:\Users\user\Desktop\2019_proj\盛行率_csv\M_66_up.csv"
#spath=r"C:\Users\user\Desktop\2019_proj\轉移率\Tra_F_0_18_ok.csv"
...
result=result.drop(['Node','count'],axis=1)
...
##執行
cursor.executemany("INSERT INTO tra_rate_m_66_up (ICD_9_1,ICD_9_2,tra_value,Trate) values(%s,%s,%s,%s)",val_list)
conn.commit()
